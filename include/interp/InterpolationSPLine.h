/*
 * $Source: /cvsroot-fuse/openvrl/ovrl/include/interp/InterpolationSPLine.h,v $
 * $Implementation: $
 * $Revision: 1.2 $
 * $Author: foxis $
...
#if !defined(AFX_INTERPOLATIONCInterpolationSPLine_H__48B351E1_A216_11D6_8083_D66192D7171A__INCLUDED_)
#define AFX_INTERPOLATIONCInterpolationSPLine_H__48B351E1_A216_11D6_8083_D66192D7171A__INCLUDED_
...
//
// CInterpolationSPLine smth
//
class OVRLIBAPI CInterpolationSPLine : public CInterpolationEngine  
{
	num_t m_points;
	C2DPoint*	m_point;
	C2DPoint	m_p;
	...
	CInterpolationSPLine();
public:
	CInterpolationSPLine(const real* p, num_t n, real delta, uint t=4);
	CInterpolationSPLine(const C2DPoint* p, num_t n, real delta, uint t=4);
	virtual ~CInterpolationSPLine();
	...
	num_t size() const { return m_points; }
...
#endif // !defined(AFX_INTERPOLATIONCInterpolationSPLine_H__48B351E1_A216_11D6_8083_D66192D7171A__INCLUDED_)
